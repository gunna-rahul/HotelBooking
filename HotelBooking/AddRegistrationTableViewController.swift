...
class AddRegistrationTableViewController: UITableViewController,SelectRoomTypeTableViewControllerDelegate {
    ...
    var registration:Registration?{
        ...
        return Registration(firstName: firstName, lastName: lastName, emailAddress: email, checkInDate: checkInDate, chekOutDate: checkOutDate, numberOfAdults: numberOfAdults, numberOfChildrens: numberOfChildren, Wifi: hasWifi, roomType: roomType)
    }
    ...
    @IBOutlet weak var numberOfChildrens: UILabel!
...
//    }
    ...
    */
    ...
    func updateNumberOfGuests(){
        ...
        numberOfChildrens.text = "\(Int(numberOfChildrenStepper.value))"
    }
    func updateRoomType(){
